...
import AsyncStorage from "@react-native-async-storage/async-storage";
  ...
  export default function TelaCadastrarResultado({route}:any){
    ...
    const atualizarEP = (campo:string, valor:string) => {
        // cria variáveis auxiliares para evitar valores NaN quando vem uma string vazia
    ...
    const atualizarER = (campo:string, valor:string)=>{
        ...
        let moyers = posicao == "superior" ? moyersA : moyersB;
        ...
        <View style={styles.header}>
          ...
          <ScrollView contentContainerStyle={styles.container}>
                <View style={{flexDirection: "row", justifyContent: "center", alignItems: "center"}}>
                    <Text style={styles.subtitulo}>Qual posição está sendo calculada?</Text>
                    <Picker style={{width: 117}}
                        ...
                        >
                        <Picker.Item style={{fontSize: 10}} label="Superior" value="superior" />
                        <Picker.Item style={{fontSize: 10}} label="Inferior" value="inferior" />
                    </Picker>
                </View>
